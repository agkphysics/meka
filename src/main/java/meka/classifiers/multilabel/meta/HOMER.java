...
public class HOMER extends ProblemTransformationMethod implements Randomizable, TechnicalInformationHandler {
    ...
    private class HOMERNode extends SingleClassifierEnhancer {
         ...
         *
         * @throws Exception
         *         If an exception is thrown during label preprocessing, training the base classifier, or training any
        ...
        private void trainNode() throws Exception {
            ...
            if (newInstances.size() < c) {
                ...
                try {
                    ...
                    Result r = Evaluation.testClassifier((MultiLabelClassifier) m_Classifier, newInstances);
         ...
         *
         * @throws Exception
         *         If this node's classifier or any child classifiers throw an exception.
         */
        ...
        public LabelSplitter getSplitter() {
            return splitter;
        }
